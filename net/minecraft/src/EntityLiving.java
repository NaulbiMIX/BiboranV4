...
public abstract class EntityLiving extends Entity
{
	...
	public boolean canEntityBeSeen(TileEntitySign par1Entity)
	{
		return this.worldObj.rayTraceBlocks(this.worldObj.getWorldVec3Pool().getVecFromPool(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ), this.worldObj.getWorldVec3Pool().getVecFromPool(par1Entity.xCoord, par1Entity.yCoord, par1Entity.zCoord)) == null;
	}
	/**
	...
	protected void fall(float par1)
	{
		...
		if (var2 > 0) {
			//ultrakek
			if (!Jesus.instance.isToggled() || !Jesus.isLiquidUnderPlayer()) {
				if (var2 > 4) {
	...
	public void moveEntityWithHeading(float par1, float par2)
	{
		if(this == Client.mc.thePlayer) {
			//par1 and par2 some sort of facing, idk
			//Exception ex = new Exception();
			//ex.printStackTrace();
			//MiscUtils.sendChatClient("[moveEntityWithHeading]");
			//MiscUtils.sendChatClient("par1: " + par1);
			//MiscUtils.sendChatClient("par2: " + par2);
		}
		...
		else
		{
			...
			//TODO
			//ultrakek PRIVATE
			//2 block jump from water
			//if(Client.mc.thePlayer.isJumping) {
			//	this.motionY *= 1.152751D;
			//}
			//else {
			//	//orig
