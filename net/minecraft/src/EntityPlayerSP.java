...
public class EntityPlayerSP extends EntityPlayer
{
	...
	public EntityPlayerSP(Minecraft par1Minecraft, World par2World, Session par3Session, int par4)
	{
		...
		if (par3Session != null && par3Session.username != null && par3Session.username.length() > 0)
		{
			...
			this.skinUrl = ("http://skinsystem.ely.by/skins/?version=2&minecraft_version=1.5.2&name=" + StringUtils.stripControlCodes(par3Session.username));
		}
	...
	public void onLivingUpdate()
	{
		...
		else
		{
			...
			if(NoSlowdown.instance != null) {
				if(NoSlowdown.instance.isToggled()){
					...
					{
						this.movementInput.moveStrafe *= 10F;
						this.movementInput.moveForward *= 10F;
			...
			//ultrakek
			if(Phase.instance != null && Freecam.instance != null) {
				if(!Phase.instance.isToggled() && !Freecam.instance.isToggled())
				{
		...
		//ultrakek
		//Client.getHookManager().onPostUpdate();
	}
	...
	public void updateCloak()
	{
		...
		this.cloakUrl = ("http://skinsystem.ely.by/cloaks/?version=2&minecraft_version=1.5.2&name=" + StringUtils.stripControlCodes(this.username) + "\r\n");
	}
	...
	public boolean isSneaking()
	{
		boolean ret = false;
		try {
			ret = this.movementInput.sneak && !this.sleeping;
		}
		catch(Exception ex) {
			//SinglePlayer Crash
			//wtf
			...
			System.out.println("movementInput: " + this.movementInput);
		}
		return ret;
