...
public class GuiScreen extends Gui
{
	...
	public void handleMouseInput()
	{
		...
		if (Mouse.getEventButtonState())
		{
			...
			//ultrakek
			for(Notification n : Client.getInstance().getGUI().notifications) {
				n.mouseClicked(var1, var2, this.eventButton);
			}
		}
	...
	public void handleKeyboardInput()
	{
		...
		*/
		...
		if (Keyboard.getEventKeyState()) {
			...
			if (GuiScreen.isMacOs && eventKey == 28 && chr == '\0') {
				eventKey = 29;
			}
			this.keyTyped(chr, eventKey);
		}
	}
	...
	public void drawWorldBackground(int par1)
	{
		if (this.mc.theWorld != null)
		{
			//ultrakek
			//esc menu background
			this.drawGradientRect(0, 0, this.width, this.height, 0x60101010, 0x60101010);
		}
		else
		{
			//ultrakek
