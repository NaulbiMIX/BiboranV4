...
public abstract class GuiSlot
{
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		//ultrakek
		this.drawBackground();
		//Client.mc.fontRenderer.drawString("", 0f, 0f, 0);
		//R2DUtils.storeTexture();
		
		//UGuiMainMenu.drawBackground();
		
		int icolor = 0;
		//Color color2 = MiscUtils.int2Color(0x4F000000);
		//R2DUtils.drawBetterRect(0, top, width, bottom, 1, color2, color2);
		//R2DUtils.drawBetterRect(0, 0, width, height, 1, color2, color2);
		
		//R2DUtils.loadTexture();
		...
		*/
		...
		for (var11 = 0; var11 < var4; ++var11)
		{
			...
			if (var20 <= this.bottom && var20 + var13 >= this.top)
			{
				...
				{
					//ultrakek
					icolor = ColorUtil.rainbow((long) 1f, 1f).getRGB();
					...
					//ultrakek
					//R2DUtils.drawBorderedRect(var14, var20 + var13 + 2, var15, var20 - 2, 1, 0x3F0000FF, color);
					R2DUtils.drawBetterRect(var14, var20 + var13 + 2, var15, var20 - 2, 1f, 0x3F0000FF, icolor);
		...
		//ultrakek
		//top and bot background
		//this.overlayBackground(0, this.top, 255, 255);
		//this.overlayBackground(this.bottom, this.height, 255, 255);
		R2DUtils.drawBetterRect(0, 0, width, top, 1, 0x6F000000, 0x6F000000);
		R2DUtils.drawBetterRect(0, bottom, width, height, 1, 0x6F000000, 0x6F000000);
