...
public class Packet209SetPlayerTeam extends Packet
{
    ...
    {
		//UltraKek
		if(Client.getInstance().SetPlayerTeam_log)
			System.out.println("===Packet209SetPlayerTeam.106===");
        ...
        if (this.mode == 0 || this.mode == 2)
        {
            ...
            //UltraKek
            if(Client.getInstance().SetPlayerTeam_log) {
				System.out.println("teamDisplayName : " + teamDisplayName);
				System.out.println("teamPrefix : " + teamPrefix);
				System.out.println("teamSuffix : " + teamSuffix);
			}
        }
        ...
        if (this.mode == 0 || this.mode == 3 || this.mode == 4)
        {
            ...
            {
            	//Ultra Kek 
            	String str = readString(par1DataInputStream, 16);
            	
				if(Client.getInstance().SetPlayerTeam_log)
					System.out.println("str [" + var3 + "] : " + str);
