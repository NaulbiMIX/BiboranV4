...
public class Item
{
	...
	static {
		...
		Item.painting = new ItemHangingEntity(65, (Class)EntityPainting.class).setUnlocalizedName("painting");
		...
		Item.redstoneRepeater = new ItemReed(100, (Block)Block.redstoneRepeaterIdle).setUnlocalizedName("diode").setCreativeTab(CreativeTabs.tabRedstone);
		...
		Item.cauldron = new ItemReed(124, (Block)Block.cauldron).setUnlocalizedName("cauldron").setCreativeTab(CreativeTabs.tabBrewing);
		...
		Item.itemFrame = new ItemHangingEntity(133, (Class)EntityItemFrame.class).setUnlocalizedName("frame");
		...
		Item.comparator = new ItemReed(148, (Block)Block.redstoneComparatorIdle).setUnlocalizedName("comparator").setCreativeTab(CreativeTabs.tabRedstone);
