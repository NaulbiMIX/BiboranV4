...
public class Packet2ClientProtocol extends Packet
{
    ...
    public Packet2ClientProtocol(int par1, String par2Str, final String par3Str, final int par4)
    {
        ...
        //ultrakek
        Client.realNickname = this.username;
        /*
        new Thread(new Runnable() {
        	public void run() {
        		MiscUtils.getServerInfo(par3Str, par4);
        	}
        }).start();
        */
        //-1681 2426
