...
public class GuiVideoSettings extends GuiScreen
{
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		//ultrakek
		//Color color1 = MiscUtils.int2Color(0x80101010);
		...
		if (Math.abs(par1 - this.lastMouseX) <= 5 && Math.abs(par2 - this.lastMouseY) <= 5)
		{
			...
			if (System.currentTimeMillis() >= this.mouseStillTime + (long)var4)
			{
				...
				if (var9 != null)
				{
					...
					//R2DUtils.drawGradientRect(var5, var6, var7, var8, 0xE0000000, 0xE0000000);
					//ultrakek
					int color = ColorUtil.rainbow((long) 1f, 1f).getRGB();
					R2DUtils.drawGradientBorderedRect(x, y, x2, y2, 2, color, 0xAE000000, 0xFF000000);

					for (int var12 = 0; var12 < var11.length; ++var12)
					{
						String var13 = var11[var12];
						this.fontRenderer.drawStringWithShadow(var13, x + 5, y + 5 + var12 * 11, 14540253);
					}
				}
			}
		}
