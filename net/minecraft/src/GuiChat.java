...
public class GuiChat extends GuiScreen
{
	...
	{
		//ultrakek
		//R2DUtils.drawRectNoBlend(2, (float)(MiscUtils.getScreenHeight() - 2), (float)(MiscUtils.getScreenWidth() - 2), MiscUtils.getScreenHeight()- 1, new Color(0xFFFFFFF).getRGB());
		R2DUtils.drawRectNoBlend(2, (float)(MiscUtils.getScreenHeight() - 2), (float)(MiscUtils.getScreenWidth() - 2), MiscUtils.getScreenHeight()- 1, new ColorUtil().rainbow(1f, 1f).getRGB());
