...
public class Scoreboard
{
	...
	{
		//ultrakek
		if(scoreObjectives != null && par1ScoreObjective != null)
			this.scoreObjectives.remove(par1ScoreObjective.getName());
		else {
			System.out.print("-==Crash Scoreboard #2==-");
			return;
		}
		//orig
		//this.scoreObjectives.remove(par1ScoreObjective.getName());
	...
	public void removePlayerFromTeam(String par1Str, ScorePlayerTeam par2ScorePlayerTeam)
	{
		...
		{
			//UltraKek
			if(Client.getInstance().ScoreboardCrash_log) {
				System.out.println("===Scoreboard.266===");
				System.out.println("par1Str : " + par1Str);
				
				
				if(this.getPlayersTeam(par1Str) != null) {
					System.out.println("this.getPlayersTeam(par1Str) : " + this.getPlayersTeam(par1Str));
					System.out.println("this.getPlayersTeam(par1Str).func_96661_b : " + this.getPlayersTeam(par1Str).func_96661_b());
					System.out.println("this.getPlayersTeam(par1Str).func_96663_f : " + this.getPlayersTeam(par1Str).func_96663_f());
					System.out.println("this.getPlayersTeam(par1Str).func_96668_e : " + this.getPlayersTeam(par1Str).func_96668_e());
					System.out.println("this.getPlayersTeam(par1Str).func_96669_c : " + this.getPlayersTeam(par1Str).func_96669_c());
					System.out.println("this.getPlayersTeam(par1Str).func_98299_i : " + this.getPlayersTeam(par1Str).func_98299_i());
					System.out.println("this.getPlayersTeam(par1Str).func_96665_g : " + this.getPlayersTeam(par1Str).func_96665_g());
					System.out.println("this.getPlayersTeam(par1Str).func_98297_h : " + this.getPlayersTeam(par1Str).func_98297_h());
				}
				else
					System.out.println("this.getPlayersTeam(par1Str) : null");
				
				if(par2ScorePlayerTeam != null) {
					System.out.println("par2ScorePlayerTeam : " + par2ScorePlayerTeam);
					System.out.println("par2ScorePlayerTeam.func_96661_b : " + par2ScorePlayerTeam.func_96661_b());
					System.out.println("par2ScorePlayerTeam.func_96663_f : " + par2ScorePlayerTeam.func_96663_f());
					System.out.println("par2ScorePlayerTeam.func_96668_e : " + par2ScorePlayerTeam.func_96668_e());
					System.out.println("par2ScorePlayerTeam.func_96669_c : " + par2ScorePlayerTeam.func_96669_c());
					System.out.println("par2ScorePlayerTeam.func_98299_i : " + par2ScorePlayerTeam.func_98299_i());
					System.out.println("par2ScorePlayerTeam.func_96665_g : " + par2ScorePlayerTeam.func_96665_g());
					System.out.println("par2ScorePlayerTeam.func_98297_h : " + par2ScorePlayerTeam.func_98297_h());
				}
				else
					System.out.println("par2ScorePlayerTeam : null");
				System.out.println("===END===");
			}
			Client.getInstance().mc.thePlayer.sendChatToPlayer("§cMinecraft ïî÷òè êðàøíóëñÿ èç çà: §a" + par1Str);
			//orig
