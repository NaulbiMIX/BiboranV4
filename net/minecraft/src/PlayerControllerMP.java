...
public class PlayerControllerMP
{
	...
	{
		//ultrakek
		//Client.getEventManager().call(new EventBlockInteract(this, EventBlockInteract.EventType.DESTROY, par1, par2, par3));
	...
	public void clickBlock(int par1, int par2, int par3, int par4)
	{
		...
		{
			//ultrakek
			//Client.getEventManager().call(new EventBlockInteract(this, EventBlockInteract.EventType.CLICK, par1, par2, par3));
			...
			if (this.currentGameType.isCreative())
			{
				...
				//ultrakek
				//EventBlockInteract event = (EventBlockInteract) 
				//Client.getEventManager().call(new EventBlockInteract(this, EventBlockInteract.EventType.BLOCK_HIT_DELAY, par1, par2, par3));
	...
	public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
	{
		...
		//ultrakek
		//Client.getEventManager().call(new EventBlockInteract(this, EventBlockInteract.EventType.HURT, par1, par2, par3));
	...
	public boolean onPlayerRightClick(EntityPlayer par1EntityPlayer, World par2World, ItemStack par3ItemStack, int par4, int par5, int par6, int par7, Vec3 par8Vec3)
	{
		this.syncCurrentPlayItem();
		//ultrakek
		//Client.getEventManager().call(new EventBlockInteract(this, EventBlockInteract.EventType.RIGHT_CLICK, par4, par5, par6));
		...
		//lava bucket bug
		boolean ok = true;
		if(BucketBug.instance != null) {
			if(BucketBug.instance.isToggled()) {
				if(	Client.getInstance().mc.thePlayer.inventory.getCurrentItem() != null
						&& (Client.getInstance().mc.thePlayer.inventory.getCurrentItem().itemID == 326 || Client.getInstance().mc.thePlayer.inventory.getCurrentItem().itemID == 327)) {
							ok = false;
							//this.netClientHandler.addToSendQueue(new Packet7UseEntity(mc.thePlayer.entityId, -1, 0));
	...
	{
		//ultrakek
		//Client.getEventManager().call(new EventPreAttackEntity(this, par1EntityPlayer, par2Entity));
	...
	public ItemStack windowClick(int winId, int slot, int mouseClick, int shift, EntityPlayer player)
	{
		short transaction = player.openContainer.getNextTransactionID(player.inventory);
		ItemStack item = player.openContainer.slotClick(slot, mouseClick, shift, player);
		
		//Ultrakek
		/*
		System.out.print("[windowClick]");
		System.out.print(" | par1: " + par1);
		System.out.print(" | id: " + par2);
		System.out.print(" | par3: " + par3);
		System.out.print(" | par4: " + par4);
		System.out.print(" | var7: " + var7);
		System.out.println(" | var6: " + var6);
		*/
		//Ultrakek
		
		System.out.print("[Packet102WindowClick]");
		System.out.print(" | winId: " + winId);
		System.out.print(" | slot: " + slot);
		System.out.print(" | mouseClick: " + mouseClick);
		System.out.print(" | shift: " + shift);
		System.out.print(" | item: " + item);
		System.out.println(" | transaction: " + transaction);
		
		this.netClientHandler.addToSendQueue(new Packet102WindowClick(winId, slot, mouseClick, shift, item, transaction));
		return item;
	}
