...
public class EntityRenderer
{
	...
	{
		//ultrakek
		if(!NoHurtCam.instance.isToggled()){
	 ...
	 */
	void setupCameraTransform(float par1, int par2)
	{
	...
	{
		enableRender();
		boolean oldViewBobbing = mc.gameSettings.viewBobbing;
		mc.gameSettings.viewBobbing = false;
		GL11.glPushMatrix();
		setupCameraTransform(par1, par2);
		
		//ultrakek
		//Client.getEventManager().call(new EventRender3D(this, par1));
	...
	public void renderWorld(float par1, long par2)
	{
		...
		for (int var13 = 0; var13 < 2; ++var13)
		{
			...
			//ultrakek
			//Client.getHookManager().onRenderHand();
			Client.getInstance().onRender();
			...
			Client.getInstance().onRenderHand();
			//GL11.glPopMatrix();
