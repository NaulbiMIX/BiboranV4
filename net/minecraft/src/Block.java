...
public class Block
{
	...
	//ULTRA KEK
	public static double var_x = 0.0f;
	public static double var_y = 0.0f;
	public static double var_z = 0.0f;
	//ULTRA KEK
	...
	public boolean renderAsNormalBlock()
	{
		//ULTRA KEK
		//return true;
		return !XRAY.instance.isToggled();
		//return !(Client.getModuleToggled("XRAY") || Client.getModuleToggled("Fullbright"));
	}
	...
	public float getBlockBrightness(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
	{
		...
		if(XRAY.instance.isToggled())
			...
			return par1IBlockAccess.getBrightness(par2, par3, par4, Block.lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]);
		
		//return Client.getModuleToggled("XRAY") ? 1000.0f : par1IBlockAccess.getBrightness(par2, par3, par4, Block.lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]);
	...
	public int getMixedBrightnessForBlock(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
	{
		...
		//return Client.getModuleToggled("XRAY") ? 1000 : par1IBlockAccess.getLightBrightnessForSkyBlocks(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]);
		//return par1IBlockAccess.getLightBrightnessForSkyBlocks(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]);
	}
	...
	public boolean shouldSideBeRendered(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
	{
		//ULTRA KEK
		//NEW
		//return (Client.getModuleToggled("XRAY") && XRAY.opacity == 0) ? XRAY.isXrayBlock(blockID) : par5 == 0 && this.minY > 0.0D ? true : (par5 == 1 && this.maxY < 1.0D ? true : (par5 == 2 && this.minZ > 0.0D ? true : (par5 == 3 && this.maxZ < 1.0D ? true : (par5 == 4 && this.minX > 0.0D ? true : (par5 == 5 && this.maxX < 1.0D ? true : !par1IBlockAccess.isBlockOpaqueCube(par2, par3, par4))))));

		/*
		if(XRAY.enabled == true) {
			if(XRAY.opacity == 0) {
				return XRAY.isXrayBlock(blockID);
			}
		}
		...
		else if(par5 == 0 && this.minY > 0.0D) {
			return true;
		}
		else if(par5 == 1 && this.maxY < 1.0D) {
			return true;
		}
		else if(par5 == 2 && this.minZ > 0.0D) {
			return true;
		}
		else if(par5 == 3 && this.maxZ < 1.0D) {
			return true;
		}
		else if(par5 == 4 && this.minX > 0.0D) {
			return true;
		}
		else if(par5 == 5 && this.maxX < 1.0D) {
			return true;
		}
		
		return !par1IBlockAccess.isBlockOpaqueCube(par2, par3, par4);
		*/
		return (XRAY.instance.isToggled() && XRAY.opacity == 0) ? XRAY.isXrayBlock(blockID) : (CaveFinder.instance.isToggled() && blockID != 1) ? false : par5 == 0 && this.minY > 0.0D ? true : (par5 == 1 && this.maxY < 1.0D ? true : (par5 == 2 && this.minZ > 0.0D ? true : (par5 == 3 && this.maxZ < 1.0D ? true : (par5 == 4 && this.minX > 0.0D ? true : (par5 == 5 && this.maxX < 1.0D ? true : !par1IBlockAccess.isBlockOpaqueCube(par2, par3, par4))))));
	...
	public AxisAlignedBB getSelectedBoundingBoxFromPool(World par1World, int par2, int par3, int par4)
	{
		...
		return AxisAlignedBB.getAABBPool().getAABB(	(double)par2 + this.minX,
													(double)par3 + this.minY + Block.var_x,
	...
	{
		//ULTRA KEK
		return AxisAlignedBB.getAABBPool().getAABB(	(double)par2 + this.minX + Block.var_y,
													(double)par3 + this.minY + Block.var_x,
													(double)par4 + this.minZ + Block.var_y,
													(double)par2 + this.maxX + Block.var_y,
													(double)par3 + this.maxY + Block.var_z,
													(double)par4 + this.maxZ + Block.var_y);
		//return AxisAlignedBB.getAABBPool().getAABB((double)par2 + this.minX, (double)par3 + this.minY, (double)par4 + this.minZ, (double)par2 + this.maxX, (double)par3 + this.maxY, (double)par4 + this.maxZ);
	}
	...
	public int getRenderBlockPass()
	{
		...
		if(XRAY.instance.isToggled()) {
			if(XRAY.opacity != 0) {
				if(!XRAY.isXrayBlock(blockID)) {
					return 1;
				}
			}
		}
		else if(CaveFinder.instance.isToggled()) {
			if(blockID != 1) {
				return 1;
			}
		}
		...
		//return (Client.getModuleToggled("XRAY") && XRAY.opacity != 0 && !XRAY.isXrayBlock(blockID)) ? 1 : 0;
		//return 0;
	}
