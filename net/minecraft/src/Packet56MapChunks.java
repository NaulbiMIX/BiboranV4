...
public class Packet56MapChunks extends Packet
{
	...
	//private static byte[] chunkDataNotCompressed = new byte[0]; //omfg wtf is this shit dude
	private byte[] chunkDataNotCompressed = new byte[0];
	...
	public void readPacketData(DataInputStream par1DataInputStream) throws IOException
	{
		...
		if (chunkDataNotCompressed.length < this.dataLength)
		{
			...
			//MiscUtils.sendChatClient("this.dataLength:" + this.dataLength);
		}
		//MiscUtils.sendChatClient("chunkDataNotCompressed.length:" + chunkDataNotCompressed.length);
		...
		//System.out.println("Packet56MapChunks - canProcessAsync: " + this.canProcessAsync());
	}
