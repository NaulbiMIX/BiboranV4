			...
			if ((par3 & 1 << var7) != 0)
			{
				...
				else
				{
					...
					if (var9 == null)
					{
						...
						//System.out.println("FOR 5-2");
					}

					System.arraycopy(par1ArrayOfByte, var5, var9.data, 0, var9.data.length);
					var5 += var9.data.length;
					//System.out.println("FOR 5-3");
				}
			}
