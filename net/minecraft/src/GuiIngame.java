...
import hack.rawfish2d.client.gui.ingame.NewTabGui;
	...
	public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
	{
		...
		if (!this.mc.playerController.enableEverythingIsScrewedUpMode()) {
			if(!(mc.currentScreen instanceof GuiChat)) {
				//ultrakek
				//hotbar
				R2DUtils.drawRect(var6 / 2 - 92, (float)(MiscUtils.getScreenHeight() - 23), var6 / 2 + 92, MiscUtils.getScreenHeight(), 0xAF000000);
				//R2DUtils.drawRect(var6 /2 - 92, (float)(MiscUtils.getScreenHeight() - 23), var6 / 2 + 92, MiscUtils.getScreenHeight(), Integer.MIN_VALUE);
				//R2DUtils.drawRect(var6 /2 - 92, (float)(MiscUtils.getScreenHeight() - 23), var6 / 2 + 92, MiscUtils.getScreenHeight(), Integer.MIN_VALUE);
				//R2DUtils.drawRect(var6 /2 - 92, (float)(MiscUtils.getScreenHeight() - 1), var6 / 2 + 92, MiscUtils.getScreenHeight(), new Color(0xFFFFFFF).getRGB());
				R2DUtils.drawRect(var6 /2 - 92, (float)(MiscUtils.getScreenHeight() - 1), var6 / 2 + 92, MiscUtils.getScreenHeight(), new ColorUtil().rainbow(1f, 1f).getRGB());

				final int item = this.mc.thePlayer.inventory.currentItem + 1;
				float xPos = 21.0f;
				switch (item) {
					case 1: {
						xPos = 21.5f;
				...
				//ultrakek
				//selected item
				//R2DUtils.drawRect(MiscUtils.getScreenWidth() / 2 - 91 + xPos - 21.0f, (float)(MiscUtils.getScreenHeight() - 22), MiscUtils.getScreenWidth() / 2 - 91 + xPos, (float)(MiscUtils.getScreenHeight() - 2), -2130706433);
				R2DUtils.drawRect(MiscUtils.getScreenWidth() / 2 - 91 + xPos - 21.0f, (float)(MiscUtils.getScreenHeight() - 22), MiscUtils.getScreenWidth() / 2 - 91 + xPos, (float)(MiscUtils.getScreenHeight() - 2), 0x80FFFFFF);
			}
		...
		if (this.mc.isDemo())
		{
			...
			var8.drawStringWithShadow(var35, var6 - var12 - 10, 5, 0xFFFFFFFF);
			this.mc.mcProfiler.endSection();
		}
		...
		if (this.mc.gameSettings.showDebugInfo)
		{
			...
			GL11.glPushMatrix();
			//var8.drawStringWithShadow("Serj is SKidding out Morbid xDDD (" + this.mc.debug + ")", 2, 2, 16777215);
			var8.drawStringWithShadow("Minecraft 1.5.2 (" + this.mc.debug + ")", 2, 2, 0xFFFFFFFF);
			var8.drawStringWithShadow(this.mc.debugInfoRenders(), 2, 12, 0xFFFFFFFF);
			var8.drawStringWithShadow(this.mc.getEntityDebug(), 2, 22, 0xFFFFFFFF);
			var8.drawStringWithShadow(this.mc.debugInfoEntities(), 2, 32, 0xFFFFFFFF);
			var8.drawStringWithShadow(this.mc.getWorldProviderName(), 2, 42, 0xFFFFFFFF);
			/*
			try {
		        ...
		        while((line = br.readLine()) != null){
		            if(line.trim().startsWith("Card name:") || line.trim().startsWith("Current Mode:")){
		            	...
		            	var8.drawStringWithShadow(line.trim(), 2, 52, 0xFFFFFFFF);
		            }
		        }
		        br.close();
			...
			*/
			//String str1 = "Lwjgl " + Sys.getVersion() +" context running on thread " + Thread.currentThread().getName();
			//String str2 = "Adapter: " + Display.getAdapter();
			String str3 = "Driver Version: " + Display.getVersion();
			String str4 = "Vendor: " + GL11.glGetString(GL11.GL_VENDOR);
			String str5 = "OpenGL Version: " + GL11.glGetString(GL11.GL_VERSION);
			String str6 = "Renderer: " + GL11.glGetString(GL11.GL_RENDERER);
		    
			//R2DUtils.drawRightString(str1, 2, 22 + 10, 0xFFFFFFFF);
			//R2DUtils.drawRightString(str2, 2, 32 + 10, 0xFFFFFFFF);
			R2DUtils.drawRightString(str3, 2, 22, 0xFFFFFFFF);
			R2DUtils.drawRightString(str4, 2, 32, 0xFFFFFFFF);
			R2DUtils.drawRightString(str5, 2, 42, 0xFFFFFFFF);
			R2DUtils.drawRightString(str6, 2, 52, 0xFFFFFFFF);
		...
		if (this.mc.gameSettings.keyBindPlayerList.pressed && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.playerInfoList.size() > 1 || var42 != null))
		{
			...
			byte var46 = 10;
			//drawRect(var18 - 1, var46 - 1, var18 + var17 * var16, var46 + 9 * var40, 0x80000000); //orig
			
			//ultrakek
			//double hf = ((var43.size() / 3) + 1);
			//int h = (int) Math.floor(hf);
			//drawRect(var18 - 1, var46 - 1, var18 + var17 * var16, var46 + 9 * h, 0x80000000);

			//for (var20 = 0; var20 < var36; ++var20)
			for (var20 = 0; var20 < var43.size(); ++var20)
			{
				var47 = var18 + var20 % var16 * var17;
				var22 = var46 + var20 / var16 * 9;
				drawRect(var47, var22, var47 + var17 - 1, var22 + 8, 0x20FFFFFF);
				GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
				GL11.glEnable(GL11.GL_ALPHA_TEST);
				...
				if (var20 < var43.size())
				{
					...
					//System.out.println(var51); //nick with prefix
					//System.out.println(var48.name); //just nick
					var8.drawStringWithShadow(var51, var47, var22, 0xFFFFFF);
					...
					if (var42 != null) {
						...
						if (var52 - var26 > 5) {
							...
							var8.drawStringWithShadow(var57, var52 - var8.getStringWidth(var57), var22, 0xFFFFFF);
						}
					}
		...
		*/
		...
		Client.getInstance().onRenderOverlay(par3, par4);
	}
