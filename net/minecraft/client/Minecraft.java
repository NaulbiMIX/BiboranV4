...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
	...
	/** The TexturePackLister used by this instance of Minecretaft... */
	...
	public void startGame() throws LWJGLException
	{
		...
		//ultrakek
		//this.font = new CFONT(this.gameSettings, "/fonts/fontnew.png", this.renderEngine, false);
		...
		{	
			this.displayGuiScreen(new UGuiMainMenu());
		}
		*/
		if (this.serverName != null)
		{
			this.displayGuiScreen(new GuiConnecting(new UGuiMainMenu(), this, this.serverName, this.serverPort));
		}
		else
		{	
			this.displayGuiScreen(new UGuiMainMenu());
	...
	private void loadScreen() throws LWJGLException
	{
		...
		this.renderEngine.bindTexture("/backgrounds/loading.png");
		...
		*/
		...
		//Texture.bindTexture("/backgrounds/loading.png", MiscUtils.getScreenWidth(), MiscUtils.getScreenHeight());
		
		//R2DUtils.drawGradientRect(0, 0, 100, 100, 0xFFDDAA00, 0xFF00DD00);
		/*
		if(fontRenderer != null) {
			fontRenderer.drawString("UltimateHack", 0, 0, 0xFFFF0000);
		}
		*/
		//FontUtils fu = new FontUtils("Arial.ttf", Font.TRUETYPE_FONT, 15);
		//fu.drawCenteredString("UltimateHack", 200, 200, 0xFF00FF00);
...
//        		}
	...
	private void runGameLoop()
	{
		...
		else
		{
			...
			for (int var3 = 0; var3 < this.timer.elapsedTicks; ++var3)
			{
				...
				//System.out.println("timer.elapsedTicks:" + timer.elapsedTicks);
			}
	...
	private void displayDebugInfo(long par1)
	{
		if (this.mcProfiler.profilingEnabled)
		{
			...
			{
				ProfilerResult var21 = (ProfilerResult)var3.get(var14);
				String var20 = "";
				...
				var20 = var20 + var21.field_76331_c;
				this.fontRenderer.drawStringWithShadow(var20, var7 - var6, var8 + var6 / 2 + var14 * 8 + 20, var21.func_76329_a());
				this.fontRenderer.drawStringWithShadow(var20 = var18.format(var21.field_76332_a) + "%", var7 + var6 - 50 - this.fontRenderer.getStringWidth(var20), var8 + var6 / 2 + var14 * 8 + 20, var21.func_76329_a());
				this.fontRenderer.drawStringWithShadow(var20 = var18.format(var21.field_76330_b) + "%", var7 + var6 - this.fontRenderer.getStringWidth(var20), var8 + var6 / 2 + var14 * 8 + 20, var21.func_76329_a());
			}
		}
	}
	...
	public void clickMouse(int par1)
	{
		if (par1 != 0 || this.leftClickCounter <= 0)
		{
			...
			{
				//ultrakek
				//Client.getEventManager().call(new EventEntityInteract(this, par1, this.objectMouseOver.entityHit));
	...
	public void runTick()
	{
		...
		if (this.currentScreen == null || this.currentScreen.allowUserInput)
		{
			...
			while (Keyboard.next())
			{
				...
				//Client.getEventManager().call(new EventKeyPressing(this, Keyboard.getEventKey(), EventKeyPressing.EventType.NEW));
				...
				if (Keyboard.getEventKeyState())
				{
					...
					{
						//ultrakek
						//Client.getHookManager().onKeyPressed(Keyboard.getEventKey());
						Client.getInstance().onKeyPressed(Keyboard.getEventKey());
						Client.getInstance().moduleOnKeyPress("GUI", Keyboard.getEventKey());
						
						//Client.getEventManager().call(new EventKeyPressing(this, Keyboard.getEventKey(), EventKeyPressing.EventType.OLD));
						//TabGuiKeyPress tabkey = new TabGuiKeyPress(Keyboard.getEventKey());
						//tabkey.checkKey();
	...
	//ultrakek
	public static NetClientHandler netClientHandler = null;
	...
	{	
		...
		//ultrakek
		Client.mcFrame = var17;
		
		//Client.frame = var17;
		//var17.setTitle("Nifee " + "1.6" + " /"+ System.getProperty("user.name") + "/ " + System.getProperty("os.name"));
		
		Client.st = new ScreenText();
		//ultrakek
		
		var17.setTitle(Client.getInstance().st.getStaticTitleClientStr());
	...
	private void clickMiddleMouseButton()
	{
		if (this.objectMouseOver != null)
		{
			...
			{
				//Client.getEventManager().call(new EventEntityInteract(this, 2, objectMouseOver.entityHit));
				...
				else if (this.objectMouseOver.entityHit instanceof EntityItemFrame)
				{
					...
					if (var11.getDisplayedItem() == null)
					{
						var4 = Item.itemFrame.itemID;
					}
					else
					{
						var4 = var11.getDisplayedItem().itemID;
						var2 = var11.getDisplayedItem().getItemDamage();
						var3 = true;
					}
				}
				else if (this.objectMouseOver.entityHit instanceof EntityMinecart)
				{
					...
					if (var10.getMinecartType() == 2)
					{
						var4 = Item.minecartPowered.itemID;
					}
					else if (var10.getMinecartType() == 1)
					{
						var4 = Item.minecartCrate.itemID;
					}
					else if (var10.getMinecartType() == 3)
					{
						var4 = Item.minecartTnt.itemID;
					}
					else if (var10.getMinecartType() == 5)
					{
